            ...
            >
              <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl" style={{ backgroundColor: mode === 'dark' ? 'rgb(40, 44, 52)' : '', color: mode === 'dark' ? 'white' : '', }}>
                ...
                <div className="space-y-6 border-t border-gray-200 px-4 py-6">
                  ...
                  {user?.user?.email === '1@shibu.com' ? <div className="flow-root">
                  ...
                  <div className="flow-root">
                    <Link to={'/'} className="-m-2 block p-2 font-medium text-gray-900 cursor-pointer">
                      <img
                        ...
                        src="https://in.images.search.yahoo.com/images/view;_ylt=AwrPpfRJIF1lg0cPmCS9HAx.;_ylu=c2VjA3NyBHNsawNpbWcEb2lkA2E0Y2UwODBkYjAxZWQ4ZTkxYzUzY2NjYjc2ZGU2N2UzBGdwb3MDMTIEaXQDYmluZw--?back=https%3A%2F%2Fin.images.search.yahoo.com%2Fsearch%2Fimages%3Fp%3Ddollar%26type%3DE210IN826G0%26fr%3Dmcafee%26fr2%3Dpiv-web%26tab%3Dorganic%26ri%3D12&w=2435&h=3472&imgurl=purepng.com%2Fpublic%2Fuploads%2Flarge%2Fpurepng.com-dollar-signobjectsdollar-signmoney-cash-dollar-sign-object-currency-631522323964d8wuo.png&rurl=https%3A%2F%2Fpurepng.com%2Fphoto%2F2863%2Fdollar-sign&size=1460.5KB&p=dollar&oid=a4ce080db01ed8e91c53cccb76de67e3&fr2=piv-web&fr=mcafee&tt=Dollar+Sign+PNG+Image+-+PurePNG+%7C+Free+transparent+CC0+PNG+Image+Library&b=0&ni=21&no=12&ts=&tab=organic&sigr=vDbHwmc9lEVu&sigb=tj5kJMyj4A_S&sigi=GukbgCtHK1ZC&sigt=wBgdaNRfb.t4&.crumb=KCreP0Ccigc&fr=mcafee&fr2=piv-web&type=E210IN826G0"
                        alt="shibus" />                                        </Link>
                  </div>
                </div>
            ...
            <div className="flex h-16 items-center">
              ...
              <div className="ml-4 flex lg:ml-0">
                <Link to={'/'} className='flex'>
                  <div className="flex ">
                    <h1 className=' text-2xl font-bold text-black  px-2 py-1 rounded' style={{ color: mode === 'dark' ? 'white' : '', }}>ShopAdieu</h1>
                  </div>
                </Link>
              </div>
